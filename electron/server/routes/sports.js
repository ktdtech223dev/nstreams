...
const STREAMS = {
  ...
  motogp:     [{ name: 'Sportsurge', url: 'https://sportsurge.net' },
               { name: 'StreamEast', url: 'https://streameast.live' }],
  wec:        [{ name: 'Sportsurge',    url: 'https://sportsurge.net' },
               { name: 'MotorsportsTV', url: 'https://motorsport.tv' }],
  ufc:        [{ name: 'Sportsurge',   url: 'https://sportsurge.net' },
               { name: 'CrackStreams', url: 'https://crackstreams.is' },
               { name: 'StreamEast',   url: 'https://streameast.live' }],
  basketball: [{ name: 'StreamEast',  url: 'https://streameast.live' },
               { name: 'Sportsurge', url: 'https://sportsurge.net' }],
  football:   [{ name: 'StreamEast',  url: 'https://streameast.live' },
               { name: 'Sportsurge', url: 'https://sportsurge.net' }],
  hockey:     [{ name: 'StreamEast',  url: 'https://streameast.live' },
               { name: 'Sportsurge', url: 'https://sportsurge.net' }],
  baseball:   [{ name: 'StreamEast',  url: 'https://streameast.live' },
               { name: 'Sportsurge', url: 'https://sportsurge.net' }],
  soccer:     [{ name: 'Sportsurge', url: 'https://sportsurge.net' },
               { name: 'StreamEast', url: 'https://streameast.live' }],
  boxing:     [{ name: 'Sportsurge',   url: 'https://sportsurge.net' },
               { name: 'CrackStreams', url: 'https://crackstreams.is' }],
  golf:       [{ name: 'Sportsurge', url: 'https://sportsurge.net' }],
  tennis:     [{ name: 'Sportsurge', url: 'https://sportsurge.net' },
               { name: 'StreamEast', url: 'https://streameast.live' }],
  motorsports:[{ name: 'Sportsurge', url: 'https://sportsurge.net' }],
};
